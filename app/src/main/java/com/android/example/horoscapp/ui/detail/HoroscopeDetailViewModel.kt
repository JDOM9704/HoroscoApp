...
import com.android.example.horoscapp.domain.model.model.HoroscopeModel
import com.android.example.horoscapp.domain.usecase.GetPredictionUseCase
    ...
    fun getHoroscope(sign:HoroscopeModel){
        ...
        viewModelScope.launch {
            ...
            if(result != null){
                ...
                _state.value = HoroscopeDetailState.Error("Ha ocurrido un error, Intentalo mas tarde")
            }
