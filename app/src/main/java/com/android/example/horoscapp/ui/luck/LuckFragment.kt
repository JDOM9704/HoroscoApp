...
import com.android.example.horoscapp.ui.core.listeners.OnSwipeTouchListener
import com.android.example.horoscapp.ui.luck.providers.RandomCardProvider
...
val slideUpAnimation:Animation = AnimationUtils.loadAnimation(requireContext(),R.anim.slide_up)
    ...
    private fun growAnimation() {
        val growAnimation:Animation = AnimationUtils.loadAnimation(requireContext(),R.anim.grow_animation)
